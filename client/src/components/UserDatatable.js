...
import { delete_User } from '../api/userAuthApi'

const UserDataTable = ({ data, onEdit, onDelete }) => {
    ...
    return (
        <>
            ...
            <EditUserModal isOpen={isEditModalOpen} onClose={handleModalClose} data={selectedRowData} />
